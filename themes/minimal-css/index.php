...
$siteTitle = settingsManager()->get('site_name', 'Flowaxy CMS');
$siteTagline = settingsManager()->get('site_tagline', 'Сучасна CMS система');
$siteDescription = settingsManager()->get('site_description', 'Сучасна CMS система для створення сайтів');
$sitePhone = settingsManager()->get('site_phone', '');
$adminEmail = settingsManager()->get('admin_email', '');
$copyrightText = settingsManager()->get('copyright', '');
