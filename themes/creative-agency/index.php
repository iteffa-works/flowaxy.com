                            ...
                            <div class="tp-header-right d-flex justify-content-end flex-wrap align-items-center">
                                ...
                                <div class="tp-header-cta d-none d-md-flex">
                                    ...
                                    <div class="tp-header-cta-text">
                                        <span>Free Call</span>
                                        <a href="tel:0123456">02 (256) 256 025 </a>
                                    </div>
                                </div>
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            ...
            <main>
                ...
                <section class="tp-hero-area tp-hero-space tp-black-bg pt-265 pb-170 p-relative " style="background-image: url(assets/img/shape/hero-1-bg-shape.png);">
                    ...
                    <div class="container">
                        <div class="tp-hero p-relative z-index-11">
                            <div class="mb-30">
                                <h1 class="tp-hero-title wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.1s">best digital <br> <span>creative agency</span></h1>
                                <h1 class="tp-hero-title wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.4s"><i>brilliant ideas <br> for your brand</i> from canada</h1>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="tp-about-video pl-110 mb-100">
                                    ...
                                    <div class="tp-section-title-wrapper mb-33">
                                        <h2 class="tp-section-title tp_title_anim mb-20">Enjoy the power of your marketing and communication</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="tp-about-box pl-42 mb-70">
                                    <div class="tp-section-title-wrapper mb-33">
                                        <h2 class="tp-section-title mb-20 tp_title_anim">Let us building the bridge between <br> brand and customer</h2>
                ...
                <section class="tp-newsletter-area tp-newsletter-margin p-relative z-index-11 wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                    <div class="container">
                ...
                <section class="tp-services-area pt-130 pb-130" >
                    <div class="container">
                        <div class="tp-section-title-wrapper mb-50 text-center">
                            <h2 class="tp-section-title tp_title_anim mb-20">Popular services</h2>
                            <p class="tp_title_anim">Per ipsum ultrices sollicitudin iaculis platea facilisi semper aliquam up <br> senectus cursus vivamus volutpat penatibus</p>
                        </div>
                        <div class="row justify-content-center g-0">
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="tpservices br-24 mb-30  wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                    ...
                                    <div class="tpservices__text ">
                                        <h3 class="tpservices__title mb-15"><a href="services-details.html">Visual identity</a></h3>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="tpservices br-24 mb-30  wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                                    <div class="tpservices__icon mb-25">
                                        <span><i class="flaticon-sharing"></i></span>
                                    </div>
                                    <div class="tpservices__text ">
                                        <h3 class="tpservices__title mb-15"><a href="services-details.html">Branding design</a></h3>
                                        <p>Perfs ipsum ultrices sollicitudin iaculis platea facilisi</p>
                                        <div class="tpservices__list">
                                            <ul>
                                                <li>Branding Design</li>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="tpservices br-24 mb-30  wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.6s">
                                    <div class="tpservices__icon mb-25">
                                        <span><i class="flaticon-cooperation"></i></span>
                                    </div>
                                    <div class="tpservices__text ">
                                        <h3 class="tpservices__title mb-15"><a href="services-details.html">Creative solution</a></h3>
                                        <p>Perfs ipsum ultrices sollicitudin iaculis platea facilisi</p>
                                        <div class="tpservices__list">
                                            <ul>
                                                <li>Branding Design</li>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6">
                                <div class="tpservices br-24 mb-30  wow tpFadeInUp" data-wow-duration="1.5s" data-wow-delay="0.8s">
                                    <div class="tpservices__icon mb-25">
                                        <span><i class="flaticon-connections"></i></span>
                                    </div>
                                    <div class="tpservices__text ">
                                        <h3 class="tpservices__title mb-15"><a href="services-details.html">Content writing</a></h3>
                                        <p>Perfs ipsum ultrices sollicitudin iaculis platea facilisi</p>
                                        <div class="tpservices__list">
                                            <ul>
                                                <li>Branding Design</li>
                            ...
                            <div class="col-lg-6">
                                <div class="tp-project-tab-wraper">
                                    <nav>
                                        ...
                                        <button class="nav-links" id="nav-contact-tab-1" data-bs-toggle="tab" data-bs-target="#nav-contact-1" type="button" role="tab" aria-controls="nav-contact-1" aria-selected="false">Interior design</button>
                                        <button class="nav-links" id="nav-contact-tab-2" data-bs-toggle="tab" data-bs-target="#nav-contact-2" type="button" role="tab" aria-controls="nav-contact-2" aria-selected="false">Web interface</button>
                                        </div>
                                    </nav>
                                </div>
                            </div>
                ...
                <section class="tp-testimonial-area pt-130 pb-130">
                    <div class="container">
                        <div class="tp-section-title-wrapper mb-50 text-center">
                            <h2 class="tp-section-title mb-20 tp_title_anim">Client feedback</h2>
                            <p class="tp_title_anim">Per ipsum ultrices sollicitudin iaculis platea facilisi semper aliquam up <br> senectus cursus vivamus volutpat penatibus</p>
                        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <div class="tp-section-title-wrapper mb-50">
                                    <h2 class="tp-section-title tp_title_anim mb-20">Dedicated team member <br>behind your story</h2>
                                </div>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="tp-blog-post-area pt-130 pb-90">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="tp-section-title-wrapper mb-50 text-center">
                                    <h2 class="tp-section-title tp_title_anim mb-20">Recent articles </h2>
                                    <p class="tp_title_anim">Per ipsum ultrices sollicitudin iaculis platea facilisi semper aliquam up <br> senectus cursus vivamus volutpat penatibus</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="tpblog mb-40">
                                    ...
                                    <div class="tpblog__content pl-30">
                                        ...
                                        <h3 class="tpblog__title mb-25">
                                            <a href="blog-details.html">Potent be interdum ipsum
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="tpblog mb-40">
                                    ...
                                    <div class="tpblog__content pl-30">
                                        ...
                                        <h3 class="tpblog__title mb-25">
                                            <a href="blog-details.html">Leos placerat sagittis vitae
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="tpblog mb-40">
                                    ...
                                    <div class="tpblog__content pl-30">
                                        ...
                                        <h3 class="tpblog__title mb-25">
                                            <a href="blog-details.html">Metus fames dictum curae
