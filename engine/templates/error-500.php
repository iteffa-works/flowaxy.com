...
<head>
    ...
    <title data-i18n="title">500 - Внутрішня помилка сервера</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="error-container">
        ...
        <h1 class="error-title" data-i18n="title">Внутрішня помилка сервера</h1>
        <p class="error-message" data-i18n="message">Вибачте, сталася помилка на сервері. Спробуйте пізніше.</p>
    ...
    <script>
        const translations = {
            ...
            ru: {
                ...
                'message': 'Извините, произошла ошибка на сервере. Попробуйте позже.',
