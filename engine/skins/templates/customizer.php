 ...
 * Использует конфигурацию из темы (customizer.php)
 */
?>
                            ...
                            <div class="<?= $colClass ?> mb-3">
                                <?php if ($type === 'checkbox'): ?>
                                    <div class="form-check form-switch">
                                        <label for="setting_<?= htmlspecialchars($key) ?>" class="form-check-label">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php elseif ($type === 'textarea'): ?>
                                        <textarea class="form-control setting-input" 
                                                  ...
                                                  data-key="<?= htmlspecialchars($key) ?>"
                                                  rows="3"
                                                  placeholder="<?= htmlspecialchars($description) ?>"><?= htmlspecialchars($value) ?></textarea>
                                    <?php else: ?>
                                        <input type="text" 
